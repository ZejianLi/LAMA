...
# class IM_CocoSceneGraphDataset(CocoSceneGraphDataset):
#     def __init__(self, *args, **keys):
#         super().__init__(*args, **keys)

#         self.IM_images = []
#         self.IM_original_sizes = []
#         for index in trange(len(self.image_ids), leave=False):
#             image_id = self.image_ids[index]
#             filename = self.image_id_to_filename[image_id]
#             image_path = os.path.join(self.image_dir, filename)
#             with open(image_path, 'rb') as f:
...
#                     WW, HH = image.size
#                     image = self.transform(image.convert('RGB'))
#             self.IM_images.append(image)
#             self.IM_original_sizes.append((WW, HH))
...
#         image = self.IM_images[index]
#         WW, HH = self.IM_original_sizes[index]
